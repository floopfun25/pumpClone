  ...
  <div class="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 pt-20">
    <div class="container mx-auto px-4 py-8">
      <div class="text-center mb-8">
        <h1 class="text-4xl font-bold text-white mb-2">🔧 Configuration Debug</h1>
      ...
      <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          <h3 class="text-xl font-bold text-white mb-4">🌍 Environment Variables</h3>
          <div class="space-y-3 font-mono text-sm">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div>
                <div class="text-gray-300">VITE_SOLANA_NETWORK:</div>
                <div class="text-green-400">{{ envVars.VITE_SOLANA_NETWORK }}</div>
              </div>
              <div>
                <div class="text-gray-300">VITE_DEVNET_FEE_WALLET:</div>
                <div class="text-green-400 break-all">{{ envVars.VITE_DEVNET_FEE_WALLET }}</div>
              </div>
              <div>
                <div class="text-gray-300">VITE_DEVNET_TREASURY:</div>
                <div class="text-green-400 break-all">{{ envVars.VITE_DEVNET_TREASURY }}</div>
              </div>
              <div>
                <div class="text-gray-300">VITE_DEVNET_AUTHORITY:</div>
                <div class="text-green-400 break-all">{{ envVars.VITE_DEVNET_AUTHORITY }}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          <h3 class="text-xl font-bold text-white mb-4">⚙️ Loaded Configuration</h3>
          <div class="space-y-3 font-mono text-sm">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div>
                <div class="text-gray-300">Platform Fee Wallet:</div>
                <div class="text-green-400 break-all">{{ config.platform.feeWallet }}</div>
              </div>
              <div>
                <div class="text-gray-300">Platform Treasury:</div>
                <div class="text-green-400 break-all">{{ config.platform.treasury }}</div>
              </div>
              <div>
                <div class="text-gray-300">Platform Authority:</div>
                <div class="text-green-400 break-all">{{ config.platform.authority }}</div>
              </div>
              <div>
        ...
        <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          <h3 class="text-xl font-bold text-white mb-4">✅ Configuration Status</h3>
          <div class="space-y-3">
            ...
            <div class="flex items-center justify-between">
              ...
              <span :class="feeWalletSameAsTreasury ? 'text-yellow-400' : 'text-green-400'">
                {{ feeWalletSameAsTreasury ? '⚠️ SAME (collecting full trade)' : '✅ DIFFERENT' }}
              </span>
            </div>
            <div class="flex items-center justify-between">
        ...
        <!-- Expected Wallets -->
        <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          <h3 class="text-xl font-bold text-white mb-4">🎯 Expected Configuration</h3>
          <div class="space-y-3 font-mono text-sm">
            <div>
              <div class="text-gray-300">New Fee Wallet (should be used):</div>
              <div class="text-green-400 break-all">D45ywEm23MkXT6hLLopWgTmnCoyF2XKooFdGFaF75tWK</div>
            </div>
            <div>
              <div class="text-gray-300">Old Fee Wallet (should NOT be used):</div>
              <div class="text-red-400 break-all">J3X42Cu4XAFHjbLYVjDCYXwigegrZkyfDZUtTMxedqkZ</div>
            </div>
          </div>
        </div>
