    ...
    <div class="container mx-auto px-4 py-8">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div
            v-if="isDevelopment"
            class="md:col-span-2 bg-trading-surface rounded-lg border border-yellow-500 p-6"
          >
            ...
            <p class="text-yellow-400 text-sm mb-4">
              This section is only visible in development mode for testing the
          ...
          <!-- General Settings -->
          <div
            class="bg-trading-surface rounded-lg border border-binance-border p-6"
          >
            ...
            <div class="space-y-4">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-sm text-binance-gray">
            ...
            <div class="space-y-4">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-sm text-binance-gray">
                    {{ t("settings.priceAlertsDescription") }}
                  </p>
                </div>
              ...
              <div class="flex items-center justify-between">
                <div>
                  <label class="text-white font-medium">{{
                    t("settings.newTokens")
                  }}</label>
                  <p class="text-sm text-binance-gray">
                    {{ t("settings.newTokensDescription") }}
                  </p>
                </div>
                <button class="toggle-switch">
                  <span class="toggle-slider"></span>
          ...
          >
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-2">
                <a
                  href="#"
                  class="block text-binance-yellow hover:text-binance-yellow-dark transition-colors"
                >
