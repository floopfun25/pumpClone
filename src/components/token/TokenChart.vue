<template>
  <div class="card">
    ...
    <div class="relative">
      ...
      <div
        v-if="error"
        class="h-64 flex items-center justify-center text-red-500"
      >
    ...
    <div
      v-if="hasData"
      class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4 pt-4 border-t border-gray-200 dark:border-gray-700"
    >
      <div class="text-center">
...
const loadChartData = async () => {
  ...
  try {
    ...
    let data = await fetchTokenChartDataWithFallback(
      props.tokenId,
      props.tokenSymbol,
      ...
      datasets: [
        {
          ...
          pointHoverBackgroundColor:
            priceChange24h.value >= 0 ? "#22c55e" : "#ef4444",
