  ...
  <div class="card">
    ...
    <div v-if="isConnected" class="mb-6">
      <div class="flex items-start space-x-3">
        <div
          class="w-8 h-8 rounded-full bg-gradient-to-br from-primary-400 to-purple-500 flex items-center justify-center text-white text-sm font-bold"
        >
          {{ userInitials }}
        </div>
        <div class="flex-1">
    ...
    <div
      v-else
      class="mb-6 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg text-center"
    >
    ...
    <div class="space-y-4 max-h-96 overflow-y-auto">
      ...
      <div v-else>
        ...
        >
          <!-- User Avatar -->
          <div
            class="w-8 h-8 rounded-full bg-gradient-to-br from-primary-400 to-purple-500 flex items-center justify-center text-white text-sm font-bold flex-shrink-0"
          >
          ...
          <div class="flex-1 min-w-0">
            <div class="flex items-center space-x-2 mb-1">
              ...
              <span
                v-if="comment.user?.wallet_address === tokenCreator"
                class="px-2 py-0.5 bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-200 text-xs rounded-full"
              >
                Creator
              </span>
            </div>
...
const loadComments = async (reset = false) => {
  ...
  try {
    ...
    const result = await SupabaseService.getTokenComments(
      props.tokenId,
      page.value,
      pageSize,
    );
