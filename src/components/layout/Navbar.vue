      ...
      <div class="flex justify-between items-center h-16">
        ...
        <div class="flex items-center space-x-4">
          ...
          <button 
            ...
            :class="{ 'bg-trading-elevated text-binance-yellow': showMobileMenu }"
          >
            <svg 
      ...
      <div class="px-4 py-4 space-y-4">
        ...
        <div class="pt-2 border-t border-binance-border">
          ...
          <div v-else class="space-y-2">
            <!-- User Info -->
            <div class="flex items-center space-x-3 p-3 bg-trading-elevated rounded-lg">
              <div class="w-10 h-10 rounded-full bg-gradient-to-br from-binance-yellow to-primary-600 flex items-center justify-center text-black font-bold">
                {{ walletInitials }}
              </div>
              <div class="flex-1">
                <div class="text-white font-medium">{{ shortWalletAddress }}</div>
