<template>
  <div class="relative">
    ...
    >
      <div
        class="px-3 py-2 text-xs font-semibold text-binance-gray uppercase tracking-wider border-b border-binance-border"
      >
        Select Language
      </div>
      ...
      <div class="max-h-64 overflow-y-auto">
        <button
          ...
          :class="{
            'bg-trading-elevated text-binance-yellow':
