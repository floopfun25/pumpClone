<template>
  ...
  <div
    id="app"
    class="min-h-screen bg-binance-dark dark:bg-binance-dark transition-colors duration-300"
  >
    <!-- Navigation Header -->
    <Navbar />
    ...
    <div
      v-if="isMobile && uiStore.isSidebarCollapsed"
      class="mobile-create-button-container"
    >
      <router-link to="/create" class="mobile-create-button">
    ...
    <!-- Main Content Area -->
    <main
      class="bg-binance-dark transition-all duration-300"
